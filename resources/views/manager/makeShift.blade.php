...
<body>
    <div class="login-box">
        ...
        <form action="/manager/StoreShift" method="POST">
            {{ csrf_field() }}

            <div class="user-box">
                <p style="color: white"></p> <input id="yers" type="number" placeholder="سال" name="yers"><br>
            </div>
            <div class="user-box">
                <p style="color: white"></p> <input id="month" type="number" placeholder="ماه" name="month"><br>
            </div>
            <div class="user-box">
    ...
    <div class="container">
        ...
        <form action="{{ $item->id }}/deleteShift" method="POST">
                    {{ csrf_field() }}
                    @method('delete')
                    <tbody>
                        <tr>
