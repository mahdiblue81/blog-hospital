...
<body>
    <div class="login-box">
        ...
        <form action="/manager/StoreSkill" method="POST">
            {{ csrf_field() }}

            <div class="user-box">

                <input type="text" placeholder="تخصص" name="skill"><br>
            </div>
            <a href="#">
    ...
    <div class="container">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <td> {{ $item->title }}</td>
                    <form action="/manager/{{ $item->id }}/deleteSkill" method="POST">
                        {{ csrf_field() }}

                        @method('delete')
                        <td> <input style="margin-left: 60px" class="btn btn-danger" type="submit" value="حذف"></td>
                    </form>
                    @endforeach
